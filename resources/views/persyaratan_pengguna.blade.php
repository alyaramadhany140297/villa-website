...
<head>
  ...
  <title>Persyaratan Pengguna • Villa Al Rasyid</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* =========================
       TERMS PAGE — SAMA GAYA DENGAN PRIVACY
    ========================= */
    .policy-hero{
      margin-top:66px;
    ...
    .policy-hero .container{ max-width:1000px; margin:0 auto; text-align:center; }
    .policy-kicker{
    ...
    .policy-title{ font-family:"Playfair Display",serif; font-weight:600; font-size:clamp(28px,3.2vw,42px); letter-spacing:.02em; margin:0 0 10px; color:var(--ink); }
    .policy-lead{ color:var(--ink-2); max-width:760px; margin:0 auto; line-height:1.8; }
    .policy-meta{ margin-top:14px; font-size:12px; color:#8A7B6F; letter-spacing:.08em; text-transform:uppercase; }
    ...
    .policy-card p, .policy-card li{ line-height:1.9; color:var(--ink-2); text-align:justify; }
    ...
    .section-title{ font-weight:600; color:var(--ink); margin:14px 0 8px; }
...
<body>
  ...
  <!-- ================= PAGE HEADER (Persyaratan) ================= -->
  <header class="policy-hero" id="policy-hero">
    <div class="container">
      <span class="policy-kicker"><i class="bi bi-file-check"></i> Legal & Terms</span>
      <h1 class="policy-title">Persyaratan Pengguna</h1>
      <p class="policy-lead">Ketentuan penggunaan situs & layanan Villa Al Rasyid, termasuk aturan tamu, waktu check-in/check-out, dan kebijakan perubahan.</p>
  ...
  <main class="policy-section" id="policy-content">
    <div class="policy-container">
      <article class="policy-card">
        <!-- 1. Pendahuluan -->
        <p id="t1"><span class="badge-num">1</span><b>Penerimaan Ketentuan.</b> Dengan mengakses atau menggunakan situs resmi Villa Al Rasyid, Anda dianggap telah membaca, memahami, dan menyetujui persyaratan ini.</p>

        <!-- 2. Check-in/out -->
        <p id="t2" class="section-title">2. Waktu Check‑in & Check‑out</p>
        <ul>
          <li>Check‑in: mulai pukul <b>14.00 WIB</b>.</li>
          <li>Check‑out: maksimal pukul <b>12.00 WIB</b>.</li>
        </ul>

        <!-- 3. Aturan Umum Tamu -->
        <p id="t3" class="section-title">3. Aturan Umum Tamu</p>
        <ul>
          <li>Dilarang membawa senjata tajam, minuman keras (miras), dan narkoba ke area villa.</li>
          <li>Dilarang merusak atau menyalahgunakan fasilitas. Kerusakan akibat kelalaian akan dibebankan kepada tamu.</li>
          <li>Kehilangan barang pribadi menjadi tanggung jawab masing‑masing tamu.</li>
          <li>Organ tunggal/karaoke diperbolehkan hingga pukul <b>00.00 WIB</b>.</li>
          <li>Harap menjaga kebersihan dan kenyamanan lingkungan villa selama menginap.</li>
        </ul>

        <!-- 4. Penggunaan Situs -->
        <p id="t4" class="section-title">4. Penggunaan Situs</p>
        <p>Informasi pada situs ini bertujuan memberikan gambaran umum mengenai layanan, fasilitas, dan kebijakan Villa Al Rasyid. Pengunjung dilarang menggunakan isi situs untuk tujuan komersial tanpa izin tertulis dari pengelola.</p>

        <!-- 5. Perubahan Kebijakan -->
        <p id="t5" class="section-title">5. Perubahan Persyaratan</p>
        <p>Villa Al Rasyid berhak mengubah atau memperbarui persyaratan ini sewaktu‑waktu tanpa pemberitahuan sebelumnya. Pengunjung disarankan untuk memeriksa halaman ini secara berkala.</p>

        <p class="last-updated"><i>Catatan: pertanyaan terkait persyaratan dapat dikirim melalui tombol WhatsApp pada bagian Reservasi.</i></p>
      </article>
    </div>
  </main>
