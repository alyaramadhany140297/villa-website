    ...
    <div class="container-dashboard">
        ...
        <div class="stats-row">
            ...
            <div class="card-stat card-blue">
                ...
                <div class="stat-value">{{ $totalReviews }} Ulasan</div>
            ...
            <div class="card-stat card-green">
                ...
                <div class="stat-value">{{ $approvedReviews }} Ulasan</div>
        ...
        <div class="card-link">
            ...
            <a href="{{ route('admin.reviews.index') }}" class="link-button">Kelola Ulasan</a>
        </div>
    </div>
