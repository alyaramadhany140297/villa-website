...
<head>
    ...
    <title>Admin Villa - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(route('admin.reviews.index')); ?>">Kelola Ulasan</a>
    ...
    <div class="content">
        <div class="navbar">
            <h3 style="margin: 0;"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h3>
...
</html><?php /**PATH C:\Users\T470s\villa-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>